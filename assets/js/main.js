...
function f(x) {
	...
	try {
		...
		var result = eqn.eval(scope); //Subsitute x in the input function // eval will make it int function
...
function clraug() {
	for (var i = 0; i < 12; i++) {
		document.getElementById('augtab').getElementsByTagName('input')[i].value = ''; //Clear table contents 
	}
}
